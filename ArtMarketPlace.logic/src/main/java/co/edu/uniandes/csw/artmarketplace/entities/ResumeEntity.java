...
/**
 * La Entidad Resume hace referencia a la hoja de vida que tiene un artista. En
...
public class ResumeEntity implements Serializable {
    ...
    /**
     * Es un metodo de acceso que tiene como proposito retorno una lista de
     * objetos del tipo ExhibitionEntity asociados al resumen.
     *
     * @return exhitions list.
     */
    ...
    /**
     * Es un metodo de acceso que tiene como proposito modicar las exhibiciones
     * asociadas a un artista a partir del resumen del mismo.
     *
     * @param exhibitions
     */
