...
/**
 * QuestionDTO es una clase que tiene como finalidad sevir de intermediador
 * entre las distintas capas de logicas del software, principalmente para el
 * manejo de las preguntas realizadas por los comprador respecto una obra de
 * arte.
 *
...
public class QuestionDTO extends BasicDTO {
    ...
    /**
     * artwork es la referencia de la obra de arter de la cual se esta
     * preguntando.
     */
    ...
    /**
     * email es es la cuenta de correo del usuario a la cual se espera que el
     * artista de respuesta a su pregunta.
     */
    private String email;

    /**
     * question es el campo dispuesto para que el usuario haga la pregunta
    ...
    /**
     * Es un metodo de acceso que retorna la obra de arte de la cual el
     * comprador hace la pregunta.
     *
    ...
    /**
     * Es un metodo de acceso que modifica la informacion de la obra de arte de
     * la cual un comprador hizo la pregunta.
     *
     * @param artwork es la nueva referenciada de obra de arte asignada a la
     * pregunta.
     */
    ...
    /**
     * Es un metodo de acceso que retorno la fecha de creacion de la pregunta
     * realizada por un comprador sobre una obra de arte.
     *
    ...
    /**
     * Es un metodo de acceso que modifica la fecha de creacion de la pregunta
     * realizada por un comprador.
     *
    ...
    /**
     * Es un metodo de acceso que modifica el correo de contacto del comprador
     * que hace la pregunta sobre una obra de arte.
     *
    ...
    /**
     * Es un metodo de acceso que retorna el correo del destinatario de la
     * pregunta.
     *
    ...
    /**
     * Es un metodo de acceso que modifica el correo del destinatario de la
     * pregunta.
     *
